...
public class GetGrandMasterTFTLeague extends TFTLeagueApiMethod {

  public GetGrandMasterTFTLeague(ApiConfig config, Platform platform) {
    super(config);
    setPlatform(platform);
    setReturnType(TFTLeagueList.class);
    setUrlBase(platform.getHost() + "/tft/league/v1/grandmaster");
