# RIOT-API-JAVA
----------
[![JitPack](https://img.shields.io/github/tag/kalunight/riot-api-java.svg?label=maven)](https://jitpack.io/#kalunight/riot-api-java/4.5.2)
----------
...
This project is also available on [Jitpack](https://jitpack.io/#kalunight/riot-api-java/4.5.2)
...
```java
dependencies {
	compile 'com.github.kalunight:riot-api-java:4.5.2'
}
```
